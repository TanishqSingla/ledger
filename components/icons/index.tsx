...
export const CircleUserRound = ({ width = 24, height = 24, fill = "none" }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width={width}
...
export const NoData = ({ width = 647.63626, height = 632.17383 }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width={width}
...
export const ListIcon = ({ width = 24, height = 24, fill = "none" }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width={width}
...
export const GridIcon = ({ width = 24, height = 24, fill = "none" }) => {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			width={width}
