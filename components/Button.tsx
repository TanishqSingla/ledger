...
export const buttonVariants = cva(
	"inline-flex items-center rounded-[20px] text-label-large font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:text-onSurface disabled:text-opacity-[0.38] disabled:bg-onSurface disabled:bg-opacity-[0.12] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
	{
		variants: {
			variant: {
				filled: "bg-primary text-onPrimary hover:shadow-md",
